        ...
        <div id="carouselExampleAutoplaying" className="mainSlider carousel slide carousel-fade py-5" data-bs-ride="carousel">
            <div className="carousel-inner">
                ...
                <div className="carousel-item">
                    <div className='infoSlider'>
                        <h1 style={{ color: "white", textAlign: "end", margin: "70px", fontWeight: "bold" }}>مكتب محاماة دولي بمعايير <br/>أداء عالمية</h1>
                        <p style={{ color: "white", textAlign: "end", margin: "70px" }}><br/> تعد المجموعة التجارية والبحرية أكبر مكتب محاماة دولي في مصر، وهذا يرجع لحجم القضايا الكبير التي تسلمها المكتب، <br/>والعملاء الدوليين والمحليين الذين تعاملوا معنا، بالإضافة إلى حجم وقوة العلاقات العامة <br/>وبروتوكولات التعاون المرتبطة بالمكتب. وقد اتخد المكتب مقره الرئيسي في قلب مدينة القاهرة<br/> ليكون منارة لتحقيق الأهداف القانونية لكافة عملائنا الكرام. تواصل الآن مع أفضل شركة محاماة رائدة في مصر.</p>
                    </div>
                    <div className='imgSlider'>
